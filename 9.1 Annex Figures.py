...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=0).RMSE.values, shading='gouraud', 
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=6).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=13).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=20).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=27).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
cbar.set_label('RMSE (°C)', fontsize=17)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=0).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawparallels(np.arange(5, 15, 0.5), labels=[1, 0, 0, 0], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=6).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=13).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=20).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=27).RMSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
#cbar.set_label('RMSE (°C)', fontsize=17)
#cbar.ax.tick_params(labelsize=17)
fig.savefig('Figure_Aux_A1.jpeg', format='jpeg', dpi=300, bbox_inches='tight')
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=0).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawparallels(np.arange(5, 15, 0.5), labels=[1, 0, 0, 0], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[1] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 7", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=6).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[2] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 14", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=13).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[3] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 21", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=20).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[4] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 28", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=27).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax_cbar = plt.axes(list_o[5])
cbar = plt.colorbar(h, cax=ax_cbar, label='SST (°C)', orientation='vertical')
cbar.set_label('MSE (°C)', fontsize=17)
cbar.ax.tick_params(labelsize=17)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=0).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawparallels(np.arange(5, 15, 0.5), labels=[1, 0, 0, 0], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=6).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=13).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=20).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=27).MSE.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
#cbar.set_label('MSE (°C)', fontsize=17)
#cbar.ax.tick_params(labelsize=17)
fig.savefig('Figure_Aux_A2.jpeg', format='jpeg', dpi=300, bbox_inches='tight')
...
h = m.pcolormesh(X_t, Y_t, R1.isel(time=0).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawparallels(np.arange(5, 15, 0.5), labels=[1, 0, 0, 0], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[1] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 7", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=6).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[2] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 14", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=13).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[3] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 21", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=20).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax.text(0., 1.01, '(' + string.ascii_uppercase[4] + ')', fontsize=20, fontweight='bold', transform=ax.transAxes)
ax.set_title("Day 28", fontsize=16, fontweight='bold')
h = m.pcolormesh(X_t, Y_t, R1.isel(time=27).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
ax_cbar = plt.axes(list_o[5])
cbar = plt.colorbar(h, cax=ax_cbar, label='SST (°C)', orientation='vertical')
cbar.set_label('MED (°C)', fontsize=17)
cbar.ax.tick_params(labelsize=17)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=0).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawparallels(np.arange(5, 15, 0.5), labels=[1, 0, 0, 0], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=6).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=13).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=20).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
h = m.pcolormesh(lonsH, latsH, R4.isel(time=27).MED.values, shading='gouraud', 
                 latlon=True, vmin=vmin, vmax=vmax, cmap='nipy_spectral')
m.fillcontinents(color='lightgray')
m.drawcoastlines(color='black', linewidth=1)
m.drawmeridians(np.arange(-180., 180., 0.5), labels=[0, 0, 0, 1], linewidth=0.01, fontsize=14)
...
fig.savefig('Figure_Aux_A3.jpeg', format='jpeg', dpi=300, bbox_inches='tight')